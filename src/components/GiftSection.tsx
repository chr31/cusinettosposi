...
export default function GiftSection({ iban, note }: { iban: string; note?: string }) {
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white/80 backdrop-blur p-6 shadow-sm text-center">
      <div className="text-lg font-medium text-gray-900">Viaggio in Giappone</div>
      <p className="text-gray-700 mt-2">
        Se desideraste farci un regalo ma non aveste idee precise, ci farebbe piacere se voleste contribuire alla nostra luna di miele in Giappone.
      </p>
      <div className="mt-4">
